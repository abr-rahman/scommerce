        ...
        return datatables()
            ...
            ->editColumn('status', function ($row) {
                if ($row->status == StatusEnum::Return->value) {
                    $html = '<div class="col-sm-5"><a href="#" class="btn btn-info badge bg-primary">Return</a> </div>';
                    return $html;
                }
            })
            ...
            ->addColumn('action', function ($row) {
                ...
                $html .= '<a class="dropdown-item border" id="check_status" href="' . route('order.return_accept', $row->id) . '">Accept</a>';
                $html .= '</div>';
                $html .= '</div>';
