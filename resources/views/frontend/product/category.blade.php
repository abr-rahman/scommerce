    ...
    <div class="mx-auto w-full xl:container px-6 py-10 text-slate-700">
        <div class="grid xl:flex items-start gap-10">
            <div class="w-full xl:w-[300px] 2xl:w-[350px] border p-5 sm:p-8">
                <div class="grid gap-10">
                    <div class="grid gap-5">
                        ...
                        <div class="grid">
                            {{-- <a href="" class="hover:text-fave-500 py-1 my-1 ">All</a> --}}
            ...
            <div class="flex-1 grid gap-5">
                ...
                <div class="">
                    <div id="shortBodyActive" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-10 mt-10">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <form action="{{ route('add.cart', $product->id) }}" method="post" id="addCart">
                                            ...
                                            <input type="hidden" name="price"
                                                value="{{ $product->userPrice->discount_fixed }}">
                                            <button type="submit"
                    ...
                    <div id="shortBodyInActive"
                        class="hidden grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-10 mt-10">
